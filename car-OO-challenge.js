...
// Create a class for a Motorcycle. This class should inherit from ***Vehicle*** and each motorcycle instance should have 
//a property called ***numWheels*** which has a value of 2. It should also have a ***revEngine*** method which returns “VROOM!!!”
...
class Garage {
    ...
    add(VehicleValue){
        if(!(VehicleValue instanceof Vehicle)){
        ...
        if(this.vehicles.length >= this.capacity){
            ...
            this.vehicles.push(VehicleValue);
